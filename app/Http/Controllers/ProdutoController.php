...
class ProdutoController extends Controller
{
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            'fornecedor' => 'exists:fornecedores,id' //exists:<table>,<column> //exists:<table>,<column>
        ];
        ...
        $feedback = [
            ...
            'fornecedores.exists' => 'O fornecedor informado nao existe'
        ];
    ...
    public function update(Request $request, Item $produto)
    {
        $rules = [
            ...
            'peso' => 'required|integer',
            'unidade_id' => 'exists:unidades,id' ,
            'fornecedor' => 'exists:fornecedores,id|required' //exists:<table>,<column>
        ];
        ...
        $feedback = [
            ...
            'integer' => 'O campo :attribute deve ser do tipo inteiro',
            'unidade_id.exists' => 'A unidade de medida informada nao existe',
            'fornecedores' => 'O fornecedor informado nao existe'
        ];
